...
package SIFilters;
//package keel.Algorithms.Preprocess.NoiseFilters.ClassNoiseCorrector;
...
public class Parameters {
	...
	public static boolean IPF_use;
	public static boolean CF_use;
	public static boolean RNG_use;	
	public static boolean NCNEdit_use;
	public static boolean ENNTh_use;
	public static boolean CVCF_use;
	public static boolean EF_use;
	
	public static double epsilon; 
	
	public static int k_ENN;
	// ----------------------------------------------
...
//*******************************************************************************************************************************
	...
	static boolean isBoolean(String paramName){
		...
		if(paramName.equalsIgnoreCase("IPF_use")) return true;
		if(paramName.equalsIgnoreCase("CF_use")) return true;
		if(paramName.equalsIgnoreCase("RNG_use")) return true;
		if(paramName.equalsIgnoreCase("NCNEdit_use")) return true;
		if(paramName.equalsIgnoreCase("ENNTh_use")) return true;
		if(paramName.equalsIgnoreCase("CVCF_use")) return true;
		if(paramName.equalsIgnoreCase("EF_use")) return true;
...
//*******************************************************************************************************************************
	...
	static boolean validateAlgorithmName(String name){
		if(name.equalsIgnoreCase("ClassNoiseCorrector")) return true;
